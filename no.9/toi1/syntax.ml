...
let rec print_value v =
  ...
  | VRecFun _ -> print_string "recfun"
  | VPair (i, j) -> print_string ("("); (print_value i); print_string (","); (print_value j); print_string (")")
  | VNil -> print_string ("[]")
  | VCons (i, j) -> print_string ("("); (print_value i); print_string ("::"); (print_value j); print_string (")")
